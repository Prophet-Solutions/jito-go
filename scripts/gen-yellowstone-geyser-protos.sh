...
GO_PACKAGE_BASE="github.com/Prophet-Solutions/yellowstone-geyser-protos"

# Define the go package directory
GO_PACKAGE_DIR="yellowstone-geyser-pb"

# Directory containing .proto files
PROTO_DIR="yellowstone-grpc/yellowstone-grpc-proto/proto"
